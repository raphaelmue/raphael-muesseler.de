...
export interface ApiLandingPageLandingPage extends Schema.SingleType {
  ...
  attributes: {
    ...
    aboutMeContainer: Attribute.Component<'components.textbox', true> &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiMasterDataMasterData extends Schema.SingleType {
  collectionName: 'master_datas';
  info: {
    singularName: 'master-data';
    pluralName: 'master-datas';
...
export interface ApiProjectProject extends Schema.CollectionType {
  ...
  attributes: {
    ...
    showOnLandingPage: Attribute.Boolean &
      Attribute.Required &
      Attribute.Private &
      Attribute.SetPluginOptions<{
        i18n: {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::master-data.master-data': ApiMasterDataMasterData;
